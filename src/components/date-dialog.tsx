...
export function DatePickerDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { if (!o) onClose(); }}>
      <DialogContent className="max-w-sm rounded-2xl p-4 z-[60]">
        <DialogHeader>
          ...
          <DayPicker
            ...
            classNames={{
              ...
              day_button: [
                ...
                "hover:bg-muted transition-colors font-normal text-foreground",
                "flex items-center justify-center mx-auto",
              ].join(" "),
              selected: [
                "[&>button]:!bg-black [&>button]:!text-white",
                "dark:[&>button]:!bg-white dark:[&>button]:!text-black",
                "[&>button]:rounded-xl [&>button]:font-medium",
              ].join(" "),
              today: "border border-border font-semibold rounded-xl",
              outside: "opacity-30 [&>button]:text-[0.7rem] [&>button]:italic",
