...
import { signInWithGoogle } from "@/src/features/auth/actions/sign-in-with-google";
import { signInWithApple } from "@/src/features/auth/actions/sign-in-with-apple";
...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  weak_password: "Пароль занадто простий (мін. 6 символів)",
...
export function LoginForm({
  ...
  const [oauthLoading, setOAuth] = useState<"google" | "apple" | null>(null);
